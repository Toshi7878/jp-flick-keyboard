...
function DeleteIcon({ filled }: { filled: boolean }) {
  return (
    <svg aria-label="delete" className="h-5 w-7 fill-current" role="img" viewBox="0 0 31 23">
      {filled ? (
        <path
          clipRule="evenodd"
          d="M10.2412 1.1807L0 11.4219L10.2412 21.663C10.9972 22.4191 12.0226 22.8438 13.0917 22.8438H26.875C29.1014 22.8438 30.9062 21.0389 30.9062 18.8125V4.03125C30.9062 1.80484 29.1014 0 26.875 0H13.0917C12.0226 0 10.9972 0.424761 10.2412 1.1807Z M14.3974 8.09629C14.0039 7.7027 14.0039 7.06461 14.3974 6.67102C14.7911 6.27742 15.4292 6.27742 15.8227 6.67102L19.1484 9.99668L22.474 6.67102C22.8675 6.27742 23.5056 6.27742 23.8993 6.67102C24.2928 7.06453 24.2928 7.7027 23.8993 8.09629L20.5735 11.4219L23.8993 14.7475C24.2928 15.1411 24.2928 15.7792 23.8993 16.1727C23.5056 16.5663 22.8675 16.5663 22.474 16.1727L19.1484 12.8471L15.8227 16.1727C15.4292 16.5663 14.7911 16.5663 14.3976 16.1727C14.0039 15.7791 14.0039 15.1411 14.3976 14.7475L17.7232 11.422L14.3974 8.09629Z"
          fillRule="evenodd"
        />
      ) : (
        <>
          <path d="M14.3974 8.09629C14.0039 7.7027 14.0039 7.06461 14.3974 6.67102C14.7911 6.27742 15.4292 6.27742 15.8227 6.67102L19.1484 9.99668L22.474 6.67102C22.8675 6.27742 23.5056 6.27742 23.8993 6.67102C24.2928 7.06453 24.2928 7.7027 23.8993 8.09629L20.5735 11.4219L23.8993 14.7475C24.2928 15.1411 24.2928 15.7792 23.8993 16.1727C23.5056 16.5663 22.8675 16.5663 22.474 16.1727L19.1484 12.8471L15.8227 16.1727C15.4292 16.5663 14.7911 16.5663 14.3976 16.1727C14.0039 15.7791 14.0039 15.1411 14.3976 14.7475L17.7232 11.422L14.3974 8.09629Z" />
          <path
            clipRule="evenodd"
            d="M10.2412 1.1807L0 11.4219L10.2412 21.663C10.9972 22.4191 12.0226 22.8438 13.0917 22.8438H26.875C29.1014 22.8438 30.9062 21.0389 30.9062 18.8125V4.03125C30.9062 1.80484 29.1014 0 26.875 0H13.0917C12.0226 0 10.9972 0.424761 10.2412 1.1807ZM26.875 21.0969H13.0917C12.4858 21.0969 11.9048 20.8562 11.4763 20.4278L2.47049 11.4219L11.4763 2.41595C11.9048 1.98758 12.4858 1.74686 13.0917 1.74686H26.875C28.1366 1.74686 29.1593 2.7696 29.1593 4.03125V18.8125C29.1593 20.0742 28.1366 21.0969 26.875 21.0969Z"
            fillRule="evenodd"
          />
        </>
      )}
...
function FnCell({ id, col, row, rowSpan, label, icon, theme, dimmed, action, onEvent }: FnCellProps) {
  ...
  return (
    ...
    >
      ...
      >
        {id === "del" ? <DeleteIcon filled={isPressed} /> : (icon ?? label)}
      </div>
    </div>
  );
}
